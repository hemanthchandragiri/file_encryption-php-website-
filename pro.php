...
?>
  ...
  <nav class="fill">
    <ul>
      ...
      <li><a href="pro.php">File Encryption</a></li>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select name="action" id="action" required class="form-control">
                  ...
                  <option value="c">Encryption</option>
                  <option value="d">Decryption</option>
                </select>
              </div>
            </div>
            <div class="form-row">
              <button type="submit" class="button" onclick="setTimeout('document.form1.reset();',1000)"><strong>Execute</strong></button>
              <button type="reset" class="button"><strong>Reset</strong></button>
            </div>
          </form>
        </div>
