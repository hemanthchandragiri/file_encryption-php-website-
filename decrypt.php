...
<br>';
  ...
  if ($error === '') {
    ...
    switch ($action) {
      case 'a':
      //mail sessions ..........
      $myfile = fopen('decrypted.txt', "w") or die("Unable to open file!");
$txt = $content;
fwrite($myfile, $txt);
...
$email_message.="Please find the attachment below for decrypted text";
...
$mime_boundary = "==Multipart_Boundary_x{$semi_rand}x";
  ...
  $strFilesName = 'decrypted.txt';  
  $strContent = chunk_split(base64_encode(file_get_contents('decrypted.txt')));  
...
@media screen and (max-width: 600px) {
  ...
  <a href="http://localhost/pikachu/home.html"><i class="fa fa-home" aria-hidden="true"></i>Home</a>
  <a href="http://localhost/pikachu/filehome.php"><i class="fa fa-fw fa-envelope"></i>File encryption</a>
  <a href="http://localhost/pikachu/about.html" target="_blank"><i class="fa fa-fw fa-building-o"></i>About File encryption</a>
      ...
      <div class="container">
        ...
        <form class="form" enctype="multipart/form-data" method="post" id="form1" name="form1" auto-complete="off">
          ...
          <div class="select">
            ...
            <div class="form-row">
              <div class="form-group">
         <label style="color:red">Do you want this decrypted file to be sent to your mail?</label>
<label for="yes">
